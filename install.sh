...
brew cask install adapter alfred android-file-transfer appcleaner caffeine docker dropbox flux gas-mask google-chrome google-chrome-canary handbrake insomnia iterm2 lastpass slack spectacle spotify spotify-notifications sublime-merge the-unarchiver tomighty transmission tunnelblick visual-studio-code vlc
